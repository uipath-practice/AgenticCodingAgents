...
[[[
![Studio Web Templates tab, filtered for "Benefit Claim", showing the Benefit Claims Processing Template card by TPEN Labs](2-setting-up-the-solution.images/2-templates-benefit-claims.jpg){ .screenshot }
|50|
...
capability enhances the capability to handle complex unstructured documents, and uses generative AI
to map fields and field groups as defined in the extraction schema and predict them with confidence
and accuracy. This advanced feature is adept at extracting data from intricate elements like complex
tables, charts, or graphs, and it structures the output effectively.
...
documents, requires a systematic and intelligent approach due to the variations in format, language,
and layout.
...
```
|30|
![Illustration of a friendly robot presenting a checklist](2-setting-up-the-solution.images/3-organized-projects-illustration.png){ width="260" }
]]]
...
![Debug configuration panel for the Eligibility context grounding index in Studio Web](2-setting-up-the-solution.images/8-eligibility-context-W.jpg){ .screenshot width="900" }

Configure the **Income Verification** context as in the picture below:

![Context resource configuration for the Income Verification context grounding index](2-setting-up-the-solution.images/9-income-verification-context-W.jpg){ .screenshot width="900" }

Configure the **Residency Verification** context as in the picture below:

![Context resource configuration for the Residency Verification context grounding index](2-setting-up-the-solution.images/10-residency-verification-context-W.jpg){ .screenshot width="900" }
