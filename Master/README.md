...
|------|---------------|--------------|
| [CourseProfile.md](CourseProfile.md) | Every course-specific value: site URL, base path, training tenant, contact, product names, plus the reuse propagation checklist | Standing up a new course, or whenever you need a course-specific value |
