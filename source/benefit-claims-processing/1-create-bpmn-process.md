<!-- Harvested from https://sites.google.com/uipath.com/agentic-automation/benefit-claims-processing/create-bpmn-process
     Images: staging/images/1-create-bpmn-process/ (2 found)
...
Modeling starts with process diagramming and optimization. Let's review the process that we will implement.

## Sample Benefit Claims process
