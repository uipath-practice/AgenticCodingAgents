<!-- Harvested from https://sites.google.com/uipath.com/agentic-automation/benefit-claims-processing/configure-api-integration-benefit-approval
     Images: staging/images/8-configure-api-integration-benefit-approval/ (9 found)
...
- **Generate benefits approval email using Gen AI**
...
**UiPath** [Integration Service](https://docs.uipath.com/integration-service/automation-cloud/latest/user-guide/introduction) is the fastest and most convenient way to automate API enabled applications. It takes care of authorization and authentication, helping you centralize management of API connections and also allowing faster integration into SaaS platforms.
...
- Email content (**JS Expression**): **"Generate an email notifying the recipient that their application for benefits has been approved. Monthly ammount: "+vars.calculation+" $."**
- Model: **gpt-5-1**
...
- Subject: **Benefits Application approved**
