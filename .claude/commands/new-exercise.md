...
Serve locally with: `python3 -m mkdocs serve -f mkdocs.local.yml`
...
Local preview (requires mkdocs serve):
  Overview:  http://127.0.0.1:8000<base-path>/<exercise-slug>/
  Lesson 1:  http://127.0.0.1:8000<base-path>/<exercise-slug>/1-verb-noun/
  Lesson 2:  http://127.0.0.1:8000<base-path>/<exercise-slug>/2-verb-noun/
  ...
